      ...
      ><div class="manager-nav">
        <el-row class="tac">
          ...
          >
            <template>
              <p></p>
              <span class="noclick">学生界面</span>
              <p></p>
            </template>
            <router-link to="/student/stuInfo" style="text-decoration:none">
              <el-menu-item index="0" @click="handleOpen">
                <i class="el-icon-user"></i>
                <span slot="title" class="first-nav" :underline="false">{{
                  this.NavList[0]
                }}</span>
              </el-menu-item>
            </router-link>
            <router-link to="/student/queryCourse" style="text-decoration:none">
...
<script>
import Breadcrumb from '@/components/stu/Breadcrumb'
